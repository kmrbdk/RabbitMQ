...
{
    public class FanoutExchange : IRabbitMQProcess
    {
        ...
        public OperationResult Listen(dynamic model = null)
        {
            ...
            try
            {
                ...
                _queue.RoutingKey = ""; // Fanout Exchange için routingKey boş geçilecektir.
        ...
        public OperationResult Send(SendModel sendModel)
        {
            ...
            try
            {
                ...
                _queue.RoutingKey = ""; // Fanout Exchange de routingKey bilgisi gerekmemektedir.
